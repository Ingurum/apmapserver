...
public class TraceParser {
	...
	public static Map<APInfo, List<Location>> parse(String traceDirectory) throws IOException
	{
		Map<APInfo, List<Location>> apInfoMap = new HashMap<APInfo, List<Location>>();
		
		BufferedReader br = new BufferedReader(new FileReader(traceDirectory));
